  ...
  class Process extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      ...
      foreach ($m->getParameters() as $key) {
        ...
        if (isset($_POST[$p])) {
          $CLICSHOPPING_ProductsWarehouse->saveCfgParam($key, $_POST[$p]);
        }
      }

      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_ProductsWarehouse->getDef('alert_cfg_saved_success'), 'success', 'ProductsWarehouse');
